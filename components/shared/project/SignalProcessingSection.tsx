    ...
    >
        <div className="container mx-auto">
          ...
          <p className="mb-4 text-lg font-medium">
            The pipeline operates on a one–dimensional mono waveform y[n]
            sampled at fs = 40 960 Hz:
          </p>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4 mb-6">
            ...
            <li>
              Peak picking with tuned parameters to determine onset times.
            </li>
            <li>
              Offset estimation from the next onset or end of file, with a
